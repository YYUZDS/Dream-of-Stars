...
const characterReplaces = {
	...
	//本体没有替换的
	bailingyun: ["old_bailingyun", "bailingyun"],
	dengzhong: ["old_dengzhong", "dengzhong"],
	fuqian: ["old_fuqian", "fuqian"],
	guoyuan: ["old_guoyuan", "guoyuan"],
	clan_hanrong: ["old_clan_hanrong", "clan_hanrong"],
	clan_hanshao: ["old_clan_hanshao", "clan_hanshao"],
	...
	renwan: ["old_renwan", "oldx_renwan", "renwan"],
	ruanyu: ["old_ruanyu", "ruanyu"],
	tianchuan: ["unlock_tianchuan"],
	mb_wangjing: ["old_mb_wangjing", "mb_wangjing"],
	clan_wangmingshan: ["old_clan_wangmingshan", "clan_wangmingshan"],
	wangtaowangyue: ["wangtaowangyue"],
	wangyan: ["old_wangyan", "wangyan"],
	dc_weifeng: ["old_dc_weifeng", "dc_weifeng"],
	clan_xuncai: ["old_clan_xuncai", "clan_xuncai"],
	clan_xunshi: ["old_clan_xunshi", "clan_xunshi"],
	clan_xunshuang: ["old_clan_xunshuang", "clan_xunshuang"],
	xunyuxunyou: ["old_xunyuxunyou", "xunyuxunyou"],
	xurong: ["old_xurong", "lm_xurong", "xurong"],
	yinfuren: ["old_yinfuren", "yinfuren"],
	zhangbu: ["old_zhangbu", "zhangbu"],
	tw_zhanghong: ["old_tw_zhanghong", "tw_zhanghong"],
	zhanghua: ["old_zhanghua", "zhanghua"],
	xin_zhangzhongjing: ["old_xin_zhangzhongjing", "xin_zhangzhongjing"],
	xia_zhaoe: ["old_xia_zhaoe", "xia_zhaoe"],
	zhugejing: ["old_zhugejing", "zhugejing"],
	dc_zhushuo: ["old_dc_zhushuo", "dc_zhushuo"],
