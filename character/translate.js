...
let lmCharacter = {//翻译
    ...
    oldx_juejin: "绝烬",
    oldx_juejin_info: "持恒技，出牌阶段或当你进入濒死状态时，你可以选择X项执行：①回复X点体力；②摸X张牌；③体力上限+X；④对一名其他角色造成X点雷电伤害（X为你脱离濒死状态的次数，至多为4，至少为1）。然后你可以发动一次“回天”。若你未使用此技能执行过选项，则你进入濒死状态后减一点体力上限并将体力回复至一点。",
    oldx_xingzhen: "星阵",
    ...
    old_mb_cuilingyi_ab: "旧崔芙",
    old_mb_cuilingyi_prefix: "旧",
    old_mbcaiqiu: "裁裘",
