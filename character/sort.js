...
const characterSorts = {
	...
	mode_extension_星之梦: {
		...
		//限定专属
		xianding_old: ["old_liufuren", "old_renwan", "oldx_renwan", "old_dc_tengfanglan", "old_liujinliupei", "old_pangfengyi", "old_zhugejing", "old_bailingyun", "old_ruanyu", "old_xurong", "old_yuanji", "old_dc_chenzhi", "old_v_machao", "old_v_zhangxingcai", "old_dc_sb_xunyu", "old_dc_sb_luxun", "old_dc_sb_hulie", "old_dc_sb_xuyou", "old_dc_sb_zhuran", "old_dc_sb_dengai", "old_dc_sb_guanyu", "old_wu_zhugeliang", "old_wu_guanyu", "old_wu_huangfusong", "old_wu_lukang", "old_dc_shen_huatuo", "old_dc_shen_sunquan"],
